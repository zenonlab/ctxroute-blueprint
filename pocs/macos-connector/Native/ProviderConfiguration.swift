// Adapted from Phosphene's private XPC interface configuration at the pinned
// revision in README.md. MIT notice retained in Native/Bridge/LICENSE.
import ExtensionFoundation
import Foundation

struct ProviderConfiguration: AppExtensionConfiguration {

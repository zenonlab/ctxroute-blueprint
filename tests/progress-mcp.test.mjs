...
test('MCP publishes the complete progress tool contract and shares the core contract', () => {
  assert.deepEqual([...PROGRESS_TOOL_NAMES].sort(), ['progress_approve_plan', 'progress_claim_ticket', 'progress_next', 'progress_open_dashboard', 'progress_read', 'progress_set_mode', 'progress_status', 'progress_update_step', 'progress_validate_plan']);

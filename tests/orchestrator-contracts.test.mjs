...
const event = { sequence: 1, event_id: 'event-one', event_type: 'TRANSACTION', operation_id: 'operation-one', revision_before: 0, revision_after: 1, entity_type: 'mission', entity_id: 'mission-one', transition: 'PREPARING->ASSIGNED', mode: 'SWARM_ON', mode_source: 'default', requested_mode: 'SWARM', resolved_mode: 'SWARM', workflow: 'STANDARD', stage: 'work', strategy: 'single-worker', policy_digest: digest, reinforcements: [], policy_justification: [], skill_id: 'blueprint-audit', skill_version: '2.0.0', validation_id: null, duration_ms: 12, exit_code: 0, git_oid_before: oid, git_oid_after: oid, result: 'SUCCESS', cause: null, policy_id: 'orchestrator', schema_id: 'state', schema_path: '/goals/0/status', keyword: 'enum', evidence_digest: digest, timestamp: '2026-09-06T12:00:00Z' };
...
const stageCheckpoint = { checkpoint_id: 'checkpoint-one', goal_id: 'goal-one', policy_digest: digest, completed_stage: 'research', completed_receipt_ids: [], artifact_refs: [], next_stage: 'decision', created_at: '2026-09-17T12:00:00Z' };
const decisionRequest = { decision_id: 'decision-one', goal_id: 'goal-one', checkpoint_id: 'checkpoint-one', policy_digest: digest, category: 'promotion', prompt: 'Promote this experiment?', allowed_alternatives: ['promote', 'reject'], status: 'PENDING', created_at: '2026-09-17T12:00:00Z' };
...
const outcomeReceipt = { receipt_id: 'outcome-one', goal_id: 'goal-one', effect: 'read-only', policy_digest: digest, evidence_refs: ['reports/audit.json'], repository_unchanged: true, integrated_commit: null, recovery_backup_refs: [], final_repository_digest: null, completed_at: '2026-09-17T12:00:00Z' };

...
test('blueprint sync previews, backs up, applies, and refuses dirty targets', async () => {
  ...
  assert.equal(preview.sourceVersion, '2026.09.06.4');
  ...
  assert.equal(applied.targetVersion, '2026.09.06.4');
  ...
  assert.equal(JSON.parse(readFileSync(join(target, '.project/blueprint-version.json'), 'utf8')).version, '2026.09.06.4');

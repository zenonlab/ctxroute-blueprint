...
const required = ['setup:check', 'workspace:check', 'governance:check', 'progress:read', 'progress:validate', 'sensor', 'sensor:blueprint', 'initialize', 'lint', 'test:coverage', 'context:benchmark:check', 'integration', 'verify'];

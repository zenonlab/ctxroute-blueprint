...
if (phase === 'research') {
  ...
  const missionIds = ['parallel', 'audit-shards'].includes(scenario) ? [`${mission.goal_id}-mission-1`, `${mission.goal_id}-mission-2`] : [`${mission.goal_id}-mission-1`];

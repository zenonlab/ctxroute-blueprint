...
| Security | blueprint infrastructure | tree-sitter Sensor and markup adapters | `npm run sensor -- <paths>` | AST-aware and comment/string-safe diagnostics, explicit-path module boundary, and declared no-runtime-proof coverage |

...
| E3 — Package de thème et sécurité | Manifeste M2-01 stable ; qualification native E2 poursuivie | D1 : contrat versionné, création par code, objet riggé, UI stylée, installation/activation, références et cache séparés ; actions typées et permissions. Deux thèmes originaux distincts, dont un 2D, sans exceptions par jeu dans le cœur. | Rig et menu représentatifs validés ; changement de thème, référence manquante et import malveillant testés ; aucune commande implicite, aucun parcours hors périmètre ; export sans données privées ; budget E2 recontrôlé. |
